...
<body>
    ...
    <nav>
        ...
        <ul id="navItems">
            ...
            <li class="listItem active"><a href="#"><i class="fa fa-home"></i> Recent Files</a></li> 

            <li  class="listItem active"><a href="#"><i class="fa fa-home"></i> Services</a></li>
            
            <li  class="listItem active"><a href="#"><i class="fa fa-home"></i> Downloads</a></li>
            
            <li  class="listItem active"><a href="#"><i class="fa fa-home"></i> Contact Us</a></li>
        </ul>
    </nav>
    </div>
